...
def sentence_to_dot(s):
    g = Digraph('G', filename='knock44.gv')
    for chk in s:
        if chk.dst != -1:
            g.edge(morphsCons(chk.morphs), morphsCons(s[chk.dst].morphs))
    g.view()
